# Generated by Django 5.1.6 on 2025-03-21 12:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Policy_Compliance_Oversight',
            fields=[
                ...
                ('policy_last_update', models.DateField()),
                ('policy_description', models.TextField()),
                ('policy_Compliance_status', models.CharField(choices=[('Approved', 'Approved'), ('Denied', 'Denied'), ('In Progress', 'In Progress')], default='In Progress', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='user',
